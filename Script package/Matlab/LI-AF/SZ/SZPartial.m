pathD=['H:\WM_data\SZ\BOLDextract\Txtoutput5\r_value_results\''partialFC.mat'];
sbj = importdata('H:\WM_data\RESTSZ\Txtoutput\RESTSZsbj.txt');
partialFC=cell(37,1);
for t=1:length(sbj)
    data=importdata(['H:\WM_data\SZ\BOLDextract\Txtoutput4\partialFC\' sbj{t} '.mat']);
    partialFC{t,1}=data;
end

ALI_pre_L=zeros(37,24);
for i=1:37
    for j=1:24
        if j==1
