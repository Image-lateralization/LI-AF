...
pathD=['H:\WM_data\SZ\BOLDextract\Txtoutput5\r_value_results\''Pearson.mat'];
sbj = importdata('H:\WM_data\RESTSZ\Txtoutput\RESTSZsbj.txt'); 
SFC=cell(37,1);
for t=1:length(sbj)
    data=importdata(['H:\WM_data\SZ\BOLDextract\Txtoutput4\PearsonFC\' sbj{t} '.mat']); 
    SFC{t,1}=data;
end
...
save(pathD,'r_L','r_R','R6','R1','R2','R7','p_L','p_R','P6','P1','P2','P7','Ml','Mr','M','MM','All_ALI_L','ALI_pre_L','ALI_pre_R','AA','NT','N_pre_L','N_pre_R','A_pre','SFC'); 
