pathD=['H:\WM_data\ADHD\BOLDextract\Txtoutput5\r_value_results\''mulregressionFC.mat'];
sbj = importdata('H:\WM_data\RESTADHD\Txtoutput\RESTADHDsbj.txt'); 
mulFC=cell(32,1);
for t=1:length(sbj)
    data=importdata(['F:\WM_data\BP\BOLDextract\Txtoutput4\mulregressionFC\' sbj{t} '.mat']); 
    mulFC{t,1}=data;
end
