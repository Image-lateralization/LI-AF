pathD=['H:\WM_data\ADHD\BOLDextract\Txtoutput5\r_value_results\''CombinedFC.mat'];
sbj = importdata('H:\WM_data\RESTADHD\Txtoutput\RESTADHDsbj.txt'); 
CombinedFC=cell(32,1);
for t=1:length(sbj)
    data=importdata(['H:\WM_data\ADHD\BOLDextract\Txtoutput4\CombinedFC\' sbj{t} '.mat']);
    CombinedFC{t,1}=data;
end
