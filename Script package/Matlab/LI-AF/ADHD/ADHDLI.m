...
load('H:\WM_data\ADHD\BOLDextract\Txtoutput4\ADHDaccuracy.mat')
sbj = importdata('H:\WM_data\RESTADHD\Txtoutput\RESTADHDsbj.txt'); 
All_ALI_L=zeros(32,24);
All_ALI_R=zeros(32,24);
for t=1:length(sbj)
    load(['H:\WM_data\ADHD\BOLDextract\Txtoutput4\ADHDActivate\' sbj{t} '.mat']);
    ALI_L=zeros(1,24);
...
[r,p]=corr(All_ALI,ADHDaccuracy,'type','pearson');
