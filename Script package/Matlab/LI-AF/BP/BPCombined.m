pathD=['H:\WM_data\BP\BOLDextract\Txtoutput5\r_value_results\''CombinedFC.mat'];
sbj = importdata('H:\WM_data\RESTBP\Txtoutput\RESTBPsbj.txt'); 
CombinedFC=cell(43,1);
for t=1:length(sbj)
    data=importdata(['H:\WM_data\BP\BOLDextract\Txtoutput4\CombinedFC\' sbj{t} '.mat']);
    CombinedFC{t,1}=data;
end
