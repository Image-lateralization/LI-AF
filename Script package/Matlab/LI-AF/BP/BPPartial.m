pathD=['H:\WM_data\BP\BOLDextract\Txtoutput5\r_value_results\''partialFC.mat'];
sbj = importdata('H:\WM_data\RESTBP\Txtoutput\RESTBPsbj.txt'); 
partialFC=cell(43,1);
for t=1:length(sbj)
    data=importdata(['H:\WM_data\BP\BOLDextract\Txtoutput4\partialFC\' sbj{t} '.mat']);
    partialFC{t,1}=data;
end

ALI_pre_L=zeros(43,24);
for i=1:43
    for j=1:24
        if j==1
...
mean(rr)
save(pathD,'r_L','r_R','R6','R1','R2','R7','p_L','p_R','P6','P1','P2','P7','Ml','Mr','M','All_ALI_L','ALI_pre_L','ALI_pre_R','AA','NT','N_pre_L','N_pre_R','A_pre'); 
